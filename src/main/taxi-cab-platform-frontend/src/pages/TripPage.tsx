...
const TripPage = () => {
    ...
    const { trips, loadingTrips, bookTrip } = useTrip();
    ...
    return (
        <div className="flex flex-col h-screen gap-4 p-4">
            ...
            <section className="flex-1 overflow-y-auto rounded-xl border p-6">
                <div className="flex justify-start">
                    <button
                        onClick={() => setTripWindowOpen(true)}
                        className="text-white text-l bg-transparent border border-white-1000 hover:opacity-70 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:bg-gray-900"
                    >
                        New Trip
                    </button>
                </div>
